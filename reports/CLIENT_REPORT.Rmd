...
# {Yueran} VERIFIED: This setup chunk ensures reproducible knitting from project root
# The code below automatically finds the project root using marker files
